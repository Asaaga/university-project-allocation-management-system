          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="container-fluid">
                <div class="col-md-12">
                  <div class="row">
                    <h5 class="text-center" style="margin-left: 400px;">Search Result</h5>
                  </div>
                </div>
              </div>
              ...
              <table class="table table-bordered">
                ...
                <?php
                 ...
                 if (isset($_POST['submit'])) {
                   ...
                   $perform = "SELECT * FROM propose_project WHERE student LIKE '%$search%' OR username LIKE '%$search%' OR project_id LIKE '%$search%' OR mat_no LIKE '%$search%' OR first_proposal LIKE '%$search%' OR second_proposal LIKE '%$search%'  OR third_proposal LIKE '%$search%'  OR final_copy LIKE '%$search%'";
                   $see = mysqli_query($conn,$perform);
                    ...
                    echo "<td><h6 class='bg-dark text-white text-center'>NAME</h6>".$row['student']."</td>
                       ...
                       <td><h6 class='bg-dark text-white text-center'>FACULTY</h6>".$row['faculty']."</td>
                        ...
                        <td><h6 class='bg-dark text-white text-center'>Project Topic</h6>".$row['third_proposal']."</td>
                         <td><h6 class='bg-dark text-white text-center'>Date</h6>".$row['date']."</td>
                      
                            <td  class='bg-light'>
                         <a href='view.php?id=<?php echo ".$row['id']." ?>'><button class='btn btn-primary'>click to view</button></a>
                        </td> 
                      ";
                    }
