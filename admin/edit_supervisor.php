    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Asign Supervisor To Student</li>
        </ol>
         ...
         <div class="col-md-12 jumbotron">
           <div class="row">
             <div class="col-md-12">
              <div class="col-md-12">
                   <div class="row">
                     <h3 class="text-center text-primary" style="margin-left: 300px;">Asign Through Project ID</h3>
                   </div>
                 </div>
                 ...
                 <?php
                  if (isset($_GET['id'])) {
                    ...
                    $sql = "UPDATE supervisor SET stud_assigned='$pro',status='1' WHERE id='$id'";
                    $req = mysqli_query($conn,$sql);

                   if ($req) {
                     echo "<span style='color:green;'><h3>Task Successful</h3></span>";
                   }
                   else{
                    echo "<span style='color:red;'><h3>Task Not Successful</h3></span>";
                   }
                 }
              } 
               ...
               <form class="form-group bg-primary" style="font-size: 20px;" method="POST">
                <div class="col-md-12">
                   <div class="row">
                     <label class="text-white">Project ID</label>
                     <input type="number" name="pro" class="form-control" placeholder="eg 1 " autocomplete="off" required>
                   </div>
                 </div>
                 <div class="col-md-12">
                   <div class="row">
                     <input type="submit" value="ASIGN" name="add" class="btn btn-info my-4">
                   </div>
                 </div>
               </form>
             </div>
