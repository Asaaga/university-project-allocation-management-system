         ...
         <div class="col-md-12 jumbotron">
           <div class="row">
             <div class="col-md-12">
              <div class="col-md-12">
                   <div class="row">
                     <h3 class="text-center text-primary" style="margin-left: 250px;">Add New Admin Into The System</h3>
                   </div>
                 </div>
                 ...
                 <?php
                    ...
                    $sql = "INSERT INTO user(username, password, matric, role, status, image) VALUES('$username','$password','admin',1,1,'$image')";
                    $req = mysqli_query($conn,$sql);
                   
                   if ($req) {
                     echo "<span style='color:green;'><h3>Admin Added</h3></span>";
                   }
                   else{
                    echo "<span style='color:red;'><h3>Admin Not Added</h3></span>";
                   }
               ...
               <form class="form-group" style="font-size: 20px;" method="POST" enctype="multipart/form-data">
                <div class="col-md-12">
                   <div class="row">
                     <label class="bg-primary">User Name</label>
                     <input type="text" name="uname" class="form-control" placeholder="Enter Username " autocomplete="off" required>
                   </div>
                 </div>
                 <div class="col-md-12">
                   <div class="row">
                     <label class="bg-primary">Password</label>
                     <input type="password" name="pass" class="form-control" placeholder="Enter Password" autocomplete="off" required>
                   </div>
                 </div>
                 <div class="col-md-12">
                   <div class="row">
                     <label class="bg-primary">Image</label>
                     <input type="file" name="image" class="form-control" placeholder="eg 1 " autocomplete="off" required>
                   </div>
                 </div>
                 <div class="col-md-12">
                   <div class="row">
                     <input type="submit" value="ADD" name="add" class="btn btn-info my-4">
                   </div>
                 </div>
               </form>
             </div>
