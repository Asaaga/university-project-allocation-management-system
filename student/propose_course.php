     ...
     <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Proposed project</li>
        </ol>
        ...
        <!-- Icon Cards-->
                  ...
                  <table class="table table-bordered">
                  		<tr>
                  			<th colspan="2" bgcolor="purple" class="text-white text-center">YOUR APPROVED OR PROPOSE PROJECT</th>
                  		</tr>
                   		<tr>
                   			<th bgcolor="orange">First Proposer</th>
                   			<td bgcolor="green"><?php echo $row['first_proposal']; ?></td>
                   		</tr>
                   		<tr>
                   			<th bgcolor="orange">Second Proposer</th>
                   			<td bgcolor="green"><?php echo $row['second_proposal']; ?></td>
                   		</tr>
                   		<tr>
                   			<th bgcolor="orange">Third Proposer</th>
                   			<td bgcolor="green"><?php echo $row['third_proposal']; ?></td>
                   		</tr>
                      <?php } ?>
                  </table>
          </div>
